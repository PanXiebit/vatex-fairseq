...
@register_criterion("video_lang_nat_loss")
class VideoLangLabelSmoothedDualImitationCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        outputs = model(src_videos, src_lengths, prev_output_tokens, tgt_tokens)
        losses, nll_loss = [], []
        for obj in outputs:
