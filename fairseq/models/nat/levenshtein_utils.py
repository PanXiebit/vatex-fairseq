...
def _get_ins_targets(in_tokens, out_tokens, padding_idx, unk_idx):
    ...
    def _get_ins_targets_cpu(in_tokens, out_tokens, padding_idx, unk_idx):
        ...
        # print("in_tokens_list: ", len(in_tokens_list), in_tokens_list[:2])

        out_tokens_list = [
            [t for t in s if t != padding_idx]
            for i, s in enumerate(out_tokens.tolist())
        ]
        # print("out_tokens_list: ", len(out_tokens_list), out_tokens_list[:2])

        full_labels = libnat.suggested_ed2_path(
            in_tokens_list, out_tokens_list, padding_idx
        )
        # print("full_labels: ", len(full_labels[0]), len(full_labels[1]), full_labels[:5])
        ...
        # print("mask_inputs: ", len(mask_inputs), mask_inputs[:5])
        ...
        # print("mask_ins_targets: ", len(mask_ins_targets), mask_ins_targets[:5])
