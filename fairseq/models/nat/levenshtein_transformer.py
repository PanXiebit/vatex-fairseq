...
class LevenshteinTransformerModel(FairseqNATModel):
    ...
    def forward(
        ...
        print("mask_ins_out: ", mask_ins_out.shape)
        ...
        print("word_predictions: ", word_predictions.shape, word_predictions[:2])
        ...
        print("word_del_targets: ", word_del_targets[:2])
