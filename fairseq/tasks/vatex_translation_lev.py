...
from fairseq.data.vatex_language_dataset import VatexLanguageDataset
...
@register_task('vatex_translation_lev')
class VatexTranslationLevenshteinTask(FairseqTask):
    """
